...
from the_west_inner.current_events.oktoberfest.oktoberfest import (
    OktoberfestEvent,
    OktoberfestEventData,
    OktoberfestBuildingData
    )

class OktoberfestEventBuilder :
    ...
    def build_event(self) -> OktoberfestEvent:
        ...
        return OktoberfestEvent(
            ...
            oktoberfest_event_data= self.build_oktoberfest_event_data(response=event_response)
        )